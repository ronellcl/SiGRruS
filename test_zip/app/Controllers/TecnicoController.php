...
class TecnicoController extends Controller {
    ...
    public function cargaMasiva() {
        ...
        try {
            ...
            $db->commit();
            $_SESSION['success'] = "✅ Entorno de pruebas generado: " . count($apellidos) . " apoderados, beneficiarios con fichas médicas, actividades, hojas de ruta, campamentos y movimientos financieros para " . count($unidades) . " unidades.";
            $this->redirect('/tecnico');
        } catch (\Exception $e) {
