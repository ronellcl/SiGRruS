    ...
    <main class="container">
        <header style="margin-bottom: 2rem; display:flex; justify-content:space-between; align-items:center;">
            <div>
                ...
                <h1 style="margin-top:0.5rem;">Apoderados de la Unidad - <?= htmlspecialchars($unidad['nombre']) ?></h1>
            </div>
        </header>

        <div class="glass-card">
            <?php if (empty($apoderados)): ?>
                <p style="text-align:center; padding: 2rem; opacity:0.7;">No hay apoderados registrados en esta unidad.</p>
            <?php else: ?>
                <table class="table">
                    <thead>
                        <tr>
